	                  ...
	                  <div class="card-body py-5 px-4 p-md-5">
	                  	<div class="row">
	                  		<div class="col">
	                  			...
	                  			<form action="<?php echo url('backend/auth/register'); ?>" method="POST" class="validate">
									<!-- <h4 class="fw-bold mb-4 text-center" style="color: #C85C57;">Inicio de Sesion</h4> -->
									<h4 class="fw-bold mb-4 text-center">Registro de Usuario</h4>
									...
									<div class="input-group align-items-start mb-4 password-container">
										<div class="form-floating flex-nowrap">
											<input class="form-control password-field" type="password" id="password_confirm" name="password_confirm" placeholder="Confirmar Contraseña:" data-rules="required|password|equals:password">
									...
									<p class="">
										¿Ya tienes cuenta?
										<a href="<?php echo url('backend/auth/login'); ?>"> Inicia sesión Aqui.</a>
									</p>
			                    </form>
	                  		</div>
	                  	</div>
